...
const commands = (fs.readFileSync('Storage/commands.json', 'utf8'));
...
bot.on('ready', () => {
    bot.user.setGame('weather hook purge and more| prefix &')
  })
...
bot.on('message', message => {
    ...
    if (msg.startsWith(prefix + 'PURGE')) { // This time we have to use startsWith, since we will be adding a number to the end of the command.
        ...
        async function purge() {
            ...
            if (!message.member.roles.find("name", "Citizens of Athens")) { // This checks to see if they DONT have it, the "!" inverts the true/false
                message.channel.send('You need the \`Citizens of Athens\` role to use this command.'); // This tells the user in chat that they need the role.
...
bot.login('Mzg3OTY1MTkxNzYzMDAxMzQ0.DU90dQ.uhZ6GN-UJI2o8N_WEygtXtyDVJ8');
